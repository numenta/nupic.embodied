...
setup(
    ...
    license="AGPLv3",
    platforms=["any"],
    url="https://github.com/numenta/nupic.embodied",
    description="Numenta Experimental Research Code for Embodied AI",
    ...
    project_urls={
        "Bug Reports": "https://github.com/numenta/nupic.embodied/issues",
        "Source": "https://github.com/numenta/nupic.embodied",
    },
    test_suite="tests",
